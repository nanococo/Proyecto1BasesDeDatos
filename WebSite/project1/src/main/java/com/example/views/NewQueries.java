...
import com.example.pojos.NewQuery1;
...
@Route(value = "newQuery1")
@CssImport("./styles/shared-styles.css")
public class NewQueries extends VerticalLayout {
    private final Services services;

    private final Grid<NewQuery1> dataGridQueryOne = new Grid<>(NewQuery1.class);

    private final NewQuery1Form newQuery1Form;


    private final Button getQuery1 = new Button("Show");

    public NewQueries(@Autowired Services services) {
        this.services = services;
        this.newQuery1Form = new NewQuery1Form(services, this);

        H1 h1 = new H1("Top 10 Tiempos");
    ...
    public void updateDataGrid(ArrayList<NewQuery1> data){
